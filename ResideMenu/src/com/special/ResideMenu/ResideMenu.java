...
public class ResideMenu extends FrameLayout {
    ...
    public ResideMenu(Context context, int layoutId) {
        super(context);
    ...
    public ResideMenu(Context context) {
        super(context);
        initViews(context, R.layout.residemenu);
    }

    protected void initViews(Context context, int layoutId) {
    ...
    protected void setShadowAdjustScaleXByOrientation() {
     ...
     * @return
     */
    protected AnimatorSet buildScaleUpAnimation(View target, float targetScaleX,
                                                float targetScaleY) {
    ...
    protected AnimatorSet buildMenuAnimation(View target, float alpha) {
    ...
    protected float getTargetScale(float currentRawX) {
    ...
    protected void showScrollViewMenu(ScrollView scrollViewMenu) {
        if (scrollViewMenu != null && scrollViewMenu.getParent() == null) {
            addView(scrollViewMenu);
        }
    }

    protected void hideScrollViewMenu(ScrollView scrollViewMenu) {
        if (scrollViewMenu != null && scrollViewMenu.getParent() != null) {
